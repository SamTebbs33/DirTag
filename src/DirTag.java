 ...
 */
public class DirTag {
    private static String aliasFilePath = "~/.dirtags";
	...
	//parse string[] args according to options, return a command line.
	try {
	...
	if(cmd.getArgList().size() > 0){
	    ...
	    String dir = System.getProperty("user.dir"); //user working directory
